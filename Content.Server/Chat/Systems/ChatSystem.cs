...
public sealed partial class ChatSystem : SharedChatSystem
{
        ...
        )
    {
        ...
        SendInVoiceRange(ChatChannel.Emotes, action, wrappedMessage, source, range, false, "", "", author);
        if (!hideLog)
            if (name != Name(source))
    ...
    private void SendLOOC(EntityUid source, ICommonSession player, string message, bool hideChat)
    {
        ...
        SendInVoiceRange(ChatChannel.LOOC, message, wrappedMessage, source, hideChat ? ChatTransmitRange.HideChat : ChatTransmitRange.Normal, false, "", "", player.UserId);
    ...
    /// </summary>
    private void SendInVoiceRange(ChatChannel channel, string message, string wrappedMessage, EntityUid source, ChatTransmitRange range, bool Canilunzt, string CanilunztMessage, string CanilunztwrappedMessage, NetUserId? author = null)
    {
