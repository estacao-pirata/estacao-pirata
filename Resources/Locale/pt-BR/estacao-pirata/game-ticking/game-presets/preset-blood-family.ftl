blood-family-role-greeting =
    Você faz parte da família de sangue.
    Seus familiares são: {$familyNames}
    Você recebeu um cartão de linha de rádio do sindicato para poder se comunicar com sua família.
