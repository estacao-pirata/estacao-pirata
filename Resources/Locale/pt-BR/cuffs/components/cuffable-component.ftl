...
cuffable-component-start-uncuffing-self = Você começa a se soltar.
cuffable-component-start-uncuffing-observer = {$user} começa a tirar as algemas de {$target}!
cuffable-component-start-uncuffing-target-message = Você começa a tirar as algemas de {$targetName}.
cuffable-component-start-uncuffing-by-other-message = {$otherName} começa a tirar as algemas de você!
