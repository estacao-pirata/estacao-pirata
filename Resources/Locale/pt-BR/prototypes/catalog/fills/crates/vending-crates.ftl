...
ent-CrateVendingMachineRestockSnacksFilled = Snack restock crate
    .desc = Contains four restock boxes, each covering a different snack vendor. Mr. Chang's,q Discount Dans, Robust Donuts, and Getmore Chocolate are featured on the advertisement.
