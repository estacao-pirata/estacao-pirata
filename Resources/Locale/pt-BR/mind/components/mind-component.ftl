...
comp-mind-examined-dead = A alma {POSS-PRONOUN($ent)} partiu.
...
comp-mind-examined-dead-and-ssd = A alma {POSS-PRONOUN($ent)} partiu e seguiu em frente. Qualquer recuperação é improvável.
