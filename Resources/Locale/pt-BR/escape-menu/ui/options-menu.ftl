...
ui-options-function-focus-chat-input-window = Falar no Chat
ui-options-function-focus-local-chat-window = Falar no Chat (IC)
ui-options-function-focus-whisper-chat-window = Falar no Chat (Whisper)
ui-options-function-focus-radio-window = Falar no Chat (Radio)
ui-options-function-focus-ooc-window = Falar no Chat (OOC)
ui-options-function-focus-admin-chat-window = Falar no Chat (Admin)
ui-options-function-focus-dead-chat-window = Falar no Chat (Dead)
ui-options-function-focus-console-chat-window = Falar no Chat (Console)
...
ui-options-function-open-info = Abrir AHelp
