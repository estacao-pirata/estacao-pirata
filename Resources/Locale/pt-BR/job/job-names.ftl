job-name-warden = oficial de justiça
job-name-security = agente
...
job-name-hop = intendente da estação
job-name-captain = capitão
job-name-serviceworker = faz-tudo
job-name-centcomoff = oficial CentCom
...
job-name-senior-officer = delegado
