...
salvage-map-proto-SmallAISurveyDrone = Drone de pesquisa AI
...
salvage-map-proto-SmallSyndicate = Nave do Sindicato em ruínas
...
salvage-map-proto-MediumHaulingShuttleWreck = Nave de transporte arruinada
...
salvage-map-proto-MediumShuttleWreck = Nave de emergência arruinada
salvage-map-proto-MediumPetHospital = Hospital de animais e ursos
salvage-map-proto-MediumCrashedShuttle = Nave acidentada
