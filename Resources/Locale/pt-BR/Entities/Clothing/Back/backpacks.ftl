...
ent-ClothingBackpackERTLeader = mochila de comandante trr
    .desc = Uma mochila espaçosa, pertencente a um Comandante da unidade TRR.

ent-ClothingBackpackERTSecurity = mochila de agente trr
    .desc = Uma mochila espaçosa, pertencente a um Agente da unidade TRR.

ent-ClothingBackpackERTMedical = mochila de médico trr
    .desc = Uma mochila espaçosa, pertencente a um Médico da unidade TRR.

ent-ClothingBackpackERTEngineer = mochila de engenheiro trr
    .desc = Uma mochila espaçosa, pertencente a um Engenheiro da unidade TRR.

ent-ClothingBackpackERTJanitor = mochila de zelador trr
    .desc = Uma mochila espaçosa, pertecente a um Zelador da unidade TRR.. Quê?!

ent-ClothingBackpackERTClown = mochila de palhaço trr
    .desc = Uma mochila muito espaçosa e buzinástica, pertencente a um membro da elite de palhaços, um Palhaço da unidade TRR!
